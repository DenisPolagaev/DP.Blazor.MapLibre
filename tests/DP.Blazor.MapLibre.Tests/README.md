# DP.Blazor.MapLibre.Tests

This test project contains unit tests for the DP.Blazor.MapLibre library, with a focus on JSON serialization/deserialization of GeoJSON features and geometries.
